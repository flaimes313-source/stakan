#!/usr/bin/env python3
"""
Market Analysis Bot - Main Application
Анализ стакана и рыночной активности
"""
import asyncio
import sys
import os
...
class MarketBot:
    ...
    async def initialize(self):
        ...
        try:
            ...
            # Связываем PostgreSQL с менеджерами
            self.orderbook_manager.set_postgres(self.postgres)
            self.level_analyzer.set_postgres(self.postgres)
